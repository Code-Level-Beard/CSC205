...
public class Searching {
	...
	public static Integer interpolationSearch(Integer[] arr, Integer target) {
		resetCounter();
		return(interpolationSearch( arr, 0, arr.length-1, target));
	}
	public static Integer interpolationSearch(Integer[] arr, int min, int max, Integer target) {
		Integer ret = null;
